...
# updates zstyle ':omz:update' mode auto # update automatically without 
# asking zstyle ':omz:update' mode reminder # just remind me to update 
# when it's time

# Uncomment the following line to change how often to auto-update (in 
# days). zstyle ':omz:update' frequency 13
...
# completion. You can also set it to another string to have that shown 
# instead of the default red dots. e.g. 
# COMPLETION_WAITING_DOTS="%F{yellow}waiting...%f" Caution: this setting 
# can cause issues with multiline prompts in zsh < 5.7.1 (see #5765) 
...
# Example format: plugins=(rails git textmate ruby lighthouse) Add 
...
# $ZSH_CUSTOM folder, with .zsh extension. Examples: - 
# $ZSH_CUSTOM/aliases.zsh - $ZSH_CUSTOM/macos.zsh For a full list of 
